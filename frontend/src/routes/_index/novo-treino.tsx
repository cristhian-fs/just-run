...
import { WorkoutFormData, workoutSchema } from "@/shared/schemas";
...
function RouteComponent() {
  const [submittedData, setSubmittedData] = useState<WorkoutFormData | null>(
    null,
  );
  ...
  function onSubmit(data: WorkoutFormData) {
    ...
    toast.success("Treino criado com sucesso!", {
      description: `"${data.title}" foi salvo no seu plano de treinamento.`,
    });
  }
  ...
  return (
    <div className="container mx-auto max-w-4xl px-2 py-4 md:py-6">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure os detalhes fundamentais de seu treino
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Estrutura do treino</CardTitle>
              <CardDescription>
                Escolha entre blocos estruturados (para treinamento intervalado)
                ou segmentos individuais
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      {submittedData && (
        <Card className="mt-8">
          <CardHeader>
            <CardTitle>Submitted Workout Data</CardTitle>
          </CardHeader>
          <CardContent>
