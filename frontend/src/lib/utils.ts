...
export function formatDateRange(startDate: string, endDate: string): string {
  ...
  const startMonth = start.toLocaleDateString("pt-BR", { month: "short", day: "numeric" })
  const endMonth = end.toLocaleDateString("pt-BR", { month: "short", day: "numeric", year: "numeric" })
