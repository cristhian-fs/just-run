...
export const CustomizePlanDialog = ({ planId }: { planId: string }) => {
	...
	const handleSubmit = (values: CustomPlanningFormData) => {
							...
							<div className='px-6 pb-6 space-y-8'>
								<Card>
									<CardHeader>
										...
										<CardDescription>
											Coloque os dados da sua corrida mais recente para calcular
											seu VDOT
										</CardDescription>
									</CardHeader>
									<CardContent>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className='flex flex-col'>
											...
											<FormDescription>
												Se tiver alguma corrida antes da duração total do plano,
												o plano se ajustará para essa corrida
											</FormDescription>
											<Popover>
												<PopoverTrigger asChild>
													<FormControl>
