...
import type { onboardingStep1 } from "@/shared/schemas";
import { NextButton } from "./next-button";
import { useMultiStepForm } from "./stepped-form";

export function OnboardingStep1() {
	const { control } = useFormContext<z.infer<typeof onboardingStep1>>();
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormControl>
								<Input {...field} type='number' className='appearance-none' />
							</FormControl>
							<FormMessage />
						</FormItem>
					)}
