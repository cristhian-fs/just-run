...
import { type TestFormData, TestFormSchema } from "@/shared/schemas";
...
interface RunningTestFormProps {
	onSubmit: (data: TestFormData) => void;
	isLoading: boolean;
	isSuccess: boolean;
}

export function RunningTestForm({
	onSubmit,
	isLoading,
	isSuccess,
}: RunningTestFormProps) {
	...
	return (
		<Form {...form}>
			...
			>
				...
				<AnimatedStateButton
					buttonCopy={{
						idle: "Registrar teste",
						loading: (
							<Loader size={16} className='text-foreground animate-spin' />
						),
						success: "Teste registrado com sucesso!",
					}}
					isLoading={isLoading}
					isSuccess={isSuccess}
					type='submit'
